...
function adm($message){
	...
	if ($cmd == "admin" || $cmd == "menu"){
			$menu .= "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
			$menu .= "                 [MENU ADMIN DO BOT]\n ";
			$menu .= "▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
			$menu .= "/addcc -  adiciona novas CC'S\n";
...
➕ Formato correto de adicionar seus cartões:* /addcc 2306500925712503|06|25|081 *você também pode utilizar mostrando o valor dela ao lado e o nível!
...
$cpf = getStr($dados, 'cpf":"','"');
				...
				$pessoas = json_decode(file_get_contents("./pessoas.json"),true);
