...
$totalccs = (sizeof($historicocc[$chat_id]['ccs'])) ? sizeof($historicocc[$chat_id]['ccs']) : 0 ;
	...
	$menu =  ['inline_keyboard' => [
		...
		[['text'=>"✔️ ACEITAR",'callback_data'=>"menu"]]
	...
	$botoes[] = ['text'=>"✔️ ACEITAR TERMOS",'callback_data'=>"menu"];

	$menu['inline_keyboard'] = array_chunk($botoes, 2);
	$confibot = json_decode(file_get_contents('./resource/conf.json') , true);

	$txt = "🆙 *| TERMOS DE COMPRA E USO*

⚠️ GARANTIMOS INFO LIVE, NÃO SALDO NA MESMA!
⚠️ NÃO GARANTIMOS A SUA APROVAÇÃO!
⚠️ NÃO ENSINAMOS A USAR A CC, COMPRE APENAS SE SOUBER O QUE ESTÀ FAZENDO!
⚠️ NÃO ACEITO TESTE NETFLIX, UBER, IFOOD, ETC...!
⚠️ UMA VEZ QUE O SALDO SEJA ADICIONADO AO BOT, NÃO TEM DEVOLUÇÂO!";
...
function comprasaldo($message){
	...
	$menu =  ['inline_keyboard' => [
		...
		[['text'=>"💵 Adicionar R$10",'callback_data'=>"pixauto"] , ['text'=>"💵 Adicionar R$15",'callback_data'=>"pixauto15"]],
		...
		[['text'=>"💵 Adicionar R$20",'callback_data'=>"pixauto20"], ['text'=>"💵 Adicionar R$25",'callback_data'=>"pixauto25"]],
...
$botoes[] = ['text'=>"⌛️ COMPROVANTE",'url'=>"{$confibot[suporte]}"];
...
$init_point = str_replace("\/", "\/", $init_point);
if(strpos($request, '"init_point":"')) {
$txt = "✅ *Geramos automaticamente um valor fixo de R$15,00 para adição de saldo em nossa store, por favor realize o pagamento abaixo pelo link de pagamento pelo método (Pix) e envie o comprovante para {$confibot[userDono]}!*
...
$init_point = str_replace("\/", "\/", $init_point);
if(strpos($request, '"init_point":"')) {
$txt = "✅ *Geramos automaticamente um valor fixo de R$20,00 para adição de saldo em nossa store, por favor realize o pagamento abaixo pelo link de pagamento pelo método (Pix) e envie o comprovante para {$confibot[userDono]}!*
...
$init_point = str_replace("\/", "\/", $init_point);
if(strpos($request, '"init_point":"')) {
$txt = "✅ *Geramos automaticamente um valor fixo de R$25,00 para adição de saldo em nossa store, por favor realize o pagamento abaixo pelo link de pagamento pelo método (Pix) e envie o comprovante para {$confibot[userDono]}!*
...
function comprasearch ($message , $id , $level , $query){
	...
	if (removesaldo($chat_id , $valor)){
		...
		$menu =  ['inline_keyboard' => [
			...
			[["text" => "🔄 REALIZAR TROCAS" , "url" => "http://telegram.me/{$confibot[userDono]}"]]
...
$confibot = $GLOBALS[confibot];
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "{$confibot[checker]}".$dadoscc['cc']."|".$dadoscc['mes']."|".$dadoscc['ano']."|".$dadoscc['cvv'].""); 
...
- *#Retorno - $response*";
		...
		$menu =  ['inline_keyboard' => [
			...
			[["text" => "🔄 REALIZAR TROCA" , "url" => "{$confibot[suporte]}"]]
...
bot("editMessageText",array( "message_id" => $message['message_id'] , "chat_id"=> $chat_id , "text" => "💳 *Comprar*

🏦 *Carteira:*
 ├ *ID:* `$chat_id`
 └💰 *Saldo: R$ {$saldo}*

_Escolha a opção desejada no menu abaixo._","reply_markup" =>$menu,"reply_to_message_id"=> $message['message_id'],"parse_mode" => 'Markdown'));
...
$totalccs = (sizeof($historicocc[$chat_id]['ccs'])) ? sizeof($historicocc[$chat_id]['ccs']) : 0 ;
	...
	$menu =  ['inline_keyboard' => [
		...
		[['text'=>"💳 Comprar",'callback_data'=>"loja"] , ['text'=>"👤 Informações",'callback_data'=>"menu_infos"] , ['text'=>"⚙️ Dev",'url'=>"https://t.me/EUTHEUZIN"]]
	...
	$botoes[] = ['text'=>"⚙️ Dev",'url'=>"https://t.me/EUTHEUZIN"]; //NÃO EDITAR PFVR

	$menu['inline_keyboard'] = array_chunk($botoes, 2);


	$txt = "━━━━━━━━━━━━━━━━━━━━━━
💎 *Olá $nome, seja bem vindo(a) na StoreBot e desde já agradecemos por ter você aqui. =)* 💎
━━━━━━━━━━━━━━━━━━━━━━
...
🏦 *Carteira:*
 ...
 └💰 *Saldo: R$ {$saldo}*
━━━━━━━━━━━━━━━━━━━━━━
📣️ *Nosso Grupo Oficial: {$confibot[usergrupo]}*
━━━━━━━━━━━━━━━━━━━━━━
🆘 *Problemas/Dúvidas? {$confibot[userDono]}*
━━━━━━━━━━━━━━━━━━━━━━";
