	...
	try{
		...
		if (in_array($cmd, $key) and $users[$chat_id]["adm"] == "true" || $confi['dono'] == $from_id){
			...
			if ($confibot['manutencao'] == "false" ){
				...
				bot("sendMessage",array("chat_id"=> $chat_id , "text" => "*❌ Modo de Manutenção ❌\n- Tente novamente mais tarde.\n⚙️ Mais informações: ".$confibot['userDono']."*","reply_to_message_id"=> $message['message_id'],"parse_mode" => 'Markdown'));
			}
		}
